 ...
 */
public final class EnglishEmptyDistribution extends AbstractNGramDistribution implements nGramLanguageDistribution {
     ...
     * @return Statistics.
     */
    @Deprecated private DescriptiveStatistics getStatistics() {
        throw new UnsupportedOperationException("Use default DescriptiveStatistics constructor instead of this.");
    }
}
