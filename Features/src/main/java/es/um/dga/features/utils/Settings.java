...
import es.um.dga.features.utils.config.Config;
...
public class Settings {
    ...
    public static String getFeatureCapabilities() {
        return (ENABLE_BASE ? ".B" : "") + (ENABLE_1G ? ".1G" : "") + (ENABLE_2G ? ".2G" : "") + (ENABLE_3G ?
                ".3G" :
                "");
    }
    ...
    /**
     * Gets the 'DataFolder' property value.
     *
     * @return value of DataFolder##
     */
    public static String getDataFolder() {
        return getAbsoluteProjectPath() + "data/";
    }
    
    /**
     * Gets the 'AbsoluteProjectPath' property value.
     * Ensures that the path ends with a trailer slash.
     *
    ...
    public static String getAbsoluteProjectPath() {
        ...
        String path = configuration.getLocalstorage().getPath();
    ...
    public static Mongodb getMongoDBConfiguration() {
        if (configuration == null) {
            loadConfiguration();
        }
