...
public class DateHelper {
    ...
    /**
     * Provides the difference between the 'start' LocalDateTime and the current LocalDateTime objects in human readable format.
     * @param start Start datetime.
     * @return Difference according to the format '[0Y ][0M ][0D ]00:00:00'
     */
    public static String humanReadableDifference(LocalDateTime start) {
        return humanReadableDifference(start, LocalDateTime.now());
    }
}
