 ...
 */
public final class EnglishDistribution extends AbstractNGramDistribution
     ...
     */
    @Deprecated
    static EnglishDistribution loadDistribution(Integer nGramSize) {
    ...
    public void loadData() {
        ...
        try {
            ...
            for (CSVRecord record : parser.getRecords()) {
                this.countDistribution.put(record.get("Token"),
                                           Double.valueOf(record.get("Count")));
                this.frequencyDistribution.put(record.get("Token"),
                                               Double.valueOf(record.get("Frequency")));
